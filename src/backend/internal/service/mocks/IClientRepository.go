...
func (_m *IClientRepository) ChangeClient(ctx context.Context, client entity.Client) error {
...
func (_m *IClientRepository) DeleteClient(ctx context.Context, clientID uuid.UUID) error {
...
func (_m *IClientRepository) GetClientByID(ctx context.Context, clientID uuid.UUID) (entity.Client, error) {
	ret := _m.Called(ctx, clientID)
...
func (_m *IClientRepository) GetClientByLogin(ctx context.Context, login string) (entity.Client, error) {
...
func (_m *IClientRepository) ListClients(ctx context.Context) ([]entity.Client, error) {
	ret := _m.Called(ctx)
...
func (_m *IClientRepository) RegisterNewClient(ctx context.Context, client entity.Client) error {
	ret := _m.Called(ctx, client)
