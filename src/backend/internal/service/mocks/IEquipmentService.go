...
// IEquipmentService is an autogenerated mock type for the IEquipmentService type
type IEquipmentService struct {
	mock.Mock
}

// ChangeEquipment provides a mock function with given fields: ctx, equipment
func (_m *IEquipmentService) ChangeEquipment(ctx context.Context, equipment entity.Equipment) error {
...
func (_m *IEquipmentService) CreateNewEquipment(ctx context.Context, equipment entity.Equipment) error {
	ret := _m.Called(ctx, equipment)
...
func (_m *IEquipmentService) DeleteEquipment(ctx context.Context, equipmentID uuid.UUID) error {
...
func (_m *IEquipmentService) GetEquipmentByID(ctx context.Context, equipmentID uuid.UUID) (entity.Equipment, error) {
	ret := _m.Called(ctx, equipmentID)
...
func (_m *IEquipmentService) ListEquipmentsByGymID(ctx context.Context, gymID uuid.UUID) ([]entity.Equipment, error) {
...
// NewIEquipmentService creates a new instance of IEquipmentService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIEquipmentService(t interface {
	mock.TestingT
	Cleanup(func())
}) *IEquipmentService {
	mock := &IEquipmentService{}
	mock.Mock.Test(t)
