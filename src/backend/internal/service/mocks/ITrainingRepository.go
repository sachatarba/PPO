...
// ITrainingRepository is an autogenerated mock type for the ITrainingRepository type
type ITrainingRepository struct {
	mock.Mock
}

// ChangeTraining provides a mock function with given fields: ctx, training
func (_m *ITrainingRepository) ChangeTraining(ctx context.Context, training entity.Training) error {
...
func (_m *ITrainingRepository) CreateNewTraining(ctx context.Context, training entity.Training) error {
	ret := _m.Called(ctx, training)
...
func (_m *ITrainingRepository) DeleteTraining(ctx context.Context, trainingID uuid.UUID) error {
...
func (_m *ITrainingRepository) ListTrainingsByTrainerID(ctx context.Context, trainerID uuid.UUID) ([]entity.Training, error) {
...
// NewITrainingRepository creates a new instance of ITrainingRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewITrainingRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *ITrainingRepository {
	mock := &ITrainingRepository{}
	mock.Mock.Test(t)
