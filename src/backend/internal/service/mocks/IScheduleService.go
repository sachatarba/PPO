...
func (_m *IScheduleService) ChangeSchedule(ctx context.Context, shedule entity.Schedule) error {
...
func (_m *IScheduleService) CreateNewSchedule(ctx context.Context, shedule entity.Schedule) error {
	ret := _m.Called(ctx, shedule)
...
func (_m *IScheduleService) DeleteSchedule(ctx context.Context, scheduleID uuid.UUID) error {
...
func (_m *IScheduleService) GetScheduleByID(ctx context.Context, sheduleID uuid.UUID) (entity.Schedule, error) {
...
func (_m *IScheduleService) ListSchedulesByClientID(ctx context.Context, clientID uuid.UUID) ([]entity.Schedule, error) {
